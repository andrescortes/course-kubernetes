...
public class CursoController {
    ...
    public ResponseEntity<?> asignarUsuario(@RequestBody Usuario usuario, @PathVariable Long cursoId, String token) {
        Optional<Usuario> o;
        try {
    ...
    public ResponseEntity<?> crearUsuario(@RequestBody Usuario usuario, @PathVariable Long cursoId, String token) {
        Optional<Usuario> o;
        try {
    ...
    public ResponseEntity<?> eliminarUsuario(@RequestBody Usuario usuario, @PathVariable Long cursoId, String token) {
        Optional<Usuario> o;
        try {
